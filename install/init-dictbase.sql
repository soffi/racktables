...
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,1,'BlackBox');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,2,'PDU');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,3,'Shelf');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,4,'Server');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,5,'DiskArray');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,6,'TapeLibrary');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,7,'Router');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,8,'Network switch');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,9,'PatchPanel');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,10,'CableOrganizer');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,11,'spacer');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,12,'UPS');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,13,'Modem');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,14,'MediaConverter');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,15,'console');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,16,'power plug');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,17,'BNC/10Base2');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,18,'RJ-45/10Base-T');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,19,'RJ-45/100Base-TX');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,20,'SC/100Base-FX');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,21,'LC/100Base-FX');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,22,'SC/100Base-SX');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,23,'LC/100Base-SX');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,24,'RJ-45/1000Base-T');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,25,'SC/1000Base-SX');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,26,'LC/1000Base-SX');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,27,'SC/1000Base-LX');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,28,'LC/1000Base-LX');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,29,'async serial (RJ-45)');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,30,'LC/10GBase-SR');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,31,'veth (Xen bridge)');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,32,'sync serial');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,33,'KVM (host)');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,34,'1000Base-ZX');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,35,'10GBase-ER');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,36,'10GBase-LR');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,37,'10GBase-LRM');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,38,'10GBase-ZR');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,39,'10GBase-LX4');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,40,'10GBase-CX4');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,41,'10GBase-Kx');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,439,'dry contact');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,440,'unknown');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,445,'KVM switch');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,446,'KVM (console)');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,447,'multiplexer');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,681,'async serial (DB-9)');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (2,682,'async serial (DB-25)');
INSERT INTO `Dictionary` (`chapter_id`, `id`, `dict_value`) VALUES (1,798,'Network security');
